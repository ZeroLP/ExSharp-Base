...
namespace ExSharpBase.Game
{
    internal class OffsetManager
    {
        ...
        public class Instances
        {
            ...
            public static int Renderer = BaseAddress + 0x3529CC8; // 8B 15 ? ? ? ? 83 EC 08 F3 // ["blurKernelSigma", +0x27F] // xref the string, move -0x27f there should be a dword.
            public static int ViewMatrix = BaseAddress + 0x3504480; // B9 ? ? ? ? E8 ? ? ? ? B9 ? ? ? ? E9 ? ? ? ? // First result: unk_0x...
